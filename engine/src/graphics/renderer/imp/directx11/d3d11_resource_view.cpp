...
D3D11VertexBuffer::D3D11VertexBuffer(D3D11GraphicBuffer *_buffer)
		: buffer(_buffer){
	CHECK_NOTNULL(buffer);
}

D3D11IndexBuffer::D3D11IndexBuffer(D3D11GraphicBuffer *_buffer)
		: buffer(_buffer){
	CHECK_NOTNULL(buffer);
}
...
D3D11StreamOut::D3D11StreamOut(D3D11GraphicBuffer *_buffer)
		: buffer(_buffer){
	CHECK_NOTNULL(buffer);
}
